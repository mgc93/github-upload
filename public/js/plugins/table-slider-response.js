...
jsPsych.plugins['table-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += `    <td class="tb-baqh-other" colspan="2"><div class = "action-other" id = "action-other-left">i</div></td>`;
    html += `    <td class="tb-baqh-other" colspan="2"><div class = "action-other" id = "action-other-right">ii</div></td>`;
    html += `  </tr>`;
    html += `  <tr>`;
    html += `    <td class="container-multi-choice-column" id= "multiattribute-choices-stimulus-top" rowspan="2"><div class = "action-self" id = "action-self-top">I</div></td>`;
    ...
    html += `  </tr>`;
    html += `  <tr>`;
    html += `    <td class="container-multi-choice-column" id= "multiattribute-choices-stimulus-bottom" rowspan="2"><div class = "action-self" id = "action-self-bottom">II</div></td>`;
    html += `    <td class="tb-0lax-top"></td>`;
